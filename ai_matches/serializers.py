...
class AIMatchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'confidence_level', 'status', 'algorithm_used', 'face_distance',
            'processing_date', 'processing_date_formatted', 'reviewed_by', 
            'reviewed_by_username', 'review_date', 'review_date_formatted',
            'admin_notes', 'original_case_details', 'matched_case_details'
        ]
        read_only_fields = [
            'id', 'processing_date', 'confidence_level', 'reviewed_by_username',
